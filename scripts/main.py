...
HISTORICAL_HEADLINES_PATH = Path("../data/processed/wsj_apple_proquest.csv")
# Fallback to sample data if ProQuest file doesn't exist yet
HISTORICAL_HEADLINES_FALLBACK = Path("../data/raw/historical_headlines.csv")
HISTORICAL_SENTIMENT_OUTPUT = Path("../results/historical_sentiment_analysis.csv")
AGGREGATED_DATA_OUTPUT = Path("../results/sentiment_stock_dataset.csv")
MODEL_RESULTS_PATH = Path("../results/model_results.md")
...
def main() -> None:
    ...
    if not live_sentiment_df.empty:
        ...
        live_sentiment_df.to_csv("../results/apple_sentiment_analysis.csv", index=False)
        print("\nResults saved to '../results/apple_sentiment_analysis.csv'")
